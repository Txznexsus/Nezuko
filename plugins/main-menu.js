...
let handler = async (m, { conn, usedPrefix, __dirname, participants }) => {
  try {
    ...
    let tags = {
      ...
      'rpg': '✎Ꮺ  `ᴍᴇɴᴜ ʀᴘɢ` 🌷 ᦡᦡ',
      'anime': '✎Ꮺ  `ᴍᴇɴᴜ ᴀɴɪᴍᴇ` 🌴',
      'search': '✎Ꮺ  `ᴍᴇɴᴜ sᴇᴀʀᴄʜ` 🌱 ᦡᦡ',
      'download': '✎Ꮺ  `ᴍᴇɴᴜ ᴅᴏᴡɴʟᴏᴀᴅ` 🌿 ᦡᦡ',
      'gacha': '✎Ꮺ  `ᴍᴇɴᴜ ɢᴀᴄʜᴀ` 🍁 ᦡᦡ',
      'rg': '✎Ꮺ  `ᴍᴇɴᴜ ᴘᴇʀғɪʟ` 🍄 ᦡᦡ',
      'game': '✎Ꮺ  `ᴍᴇɴᴜ ɢᴀᴍᴇ` 🪻 ᦡᦡ',
      'group': '✎Ꮺ  `ᴍᴇɴᴜ ɢʀᴜᴘᴏs` 🌺 ᦡᦡ',
      'nable': '✎Ꮺ  `ᴍᴇɴᴜ ɴᴀʙʟᴇ` 🍃 ᦡᦡ',
      'ia': '✎Ꮺ  `ᴍᴇɴᴜ ɪᴀ` 🍂 ᦡᦡ',
      'stalk': '✎Ꮺ  `ᴍᴇɴᴜ stalk` 🌾',
      'tools': '✎Ꮺ  `ᴍᴇɴᴜ ᴛᴏᴏʟs` 🌹 ᦡᦡ',
      'sticker': '✎Ꮺ  `ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀs` ☘️ ᦡᦡ',
      'owner': '✎Ꮺ  `ᴍᴇɴᴜ ᴏᴡɴᴇʀ` 🪴 ᦡᦡ',
      'socket': '✎Ꮺ  `ᴍᴇɴᴜ ᴊᴀᴅɪ-ʙᴏᴛ` 🪸 ᦡᦡ',
      'nsfw': '✎Ꮺ  `ᴍᴇɴᴜ ɴsғᴡ` 🪾 ᦡᦡ',
    }
